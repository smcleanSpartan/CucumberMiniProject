...
public class AddToBasketStepDefs {
    ...
    HomePage homePage = new HomePage(DriverUtilities.getInstanceOfDriverUtilities().getDriver());
    PrintedDressPage printedDress = new PrintedDressPage(DriverUtilities.getInstanceOfDriverUtilities().getDriver());
    ...
    public void i_am_on_the_page_for_the_printed_dress() {
        ...
        printedDress.goToPrintedDressPage();
    }
